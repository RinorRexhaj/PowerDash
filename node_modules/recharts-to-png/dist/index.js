...
function useGenerateImage(args) {
    ...
    const generateImage = react.useCallback(() => __awaiter(this, void 0, void 0, function* () {
...
function useCurrentPng(options) {
    ...
    const [isLoading, setIsLoading] = react.useState(false);
    const getPng = react.useCallback(() => __awaiter(this, void 0, void 0, function* () {
        var _a;
        if (ref !== null && ((_a = ref === null || ref === void 0 ? void 0 : ref.current) === null || _a === void 0 ? void 0 : _a.container)) {
            setIsLoading(true);
            return yield html2canvas__default["default"](ref.current.container, Object.assign({ logging: false }, options)).then((canvas) => {
                setIsLoading(false);
    ...
    constructor() {
        ...
        this.getPng = (options) => __awaiter(this, void 0, void 0, function* () {
            ...
            if ((_a = this.chartRef.current) === null || _a === void 0 ? void 0 : _a.container) {
                ...
                return yield html2canvas__default["default"](this.chartRef.current.container, Object.assign({}, options)).then((canvas) => {
