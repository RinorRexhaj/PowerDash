...
import { useRef, useState, useCallback, Component, createRef } from 'react';
...
function useGenerateImage(args) {
    ...
    const generateImage = useCallback(() => __awaiter(this, void 0, void 0, function* () {
        if (ref !== null && (ref === null || ref === void 0 ? void 0 : ref.current)) {
            setIsLoading(true);
            return yield html2canvas(ref.current, Object.assign({ logging: false }, args === null || args === void 0 ? void 0 : args.options)).then((canvas) => {
                setIsLoading(false);
...
function useCurrentPng(options) {
    const ref = useRef();
    const [isLoading, setIsLoading] = useState(false);
    const getPng = useCallback(() => __awaiter(this, void 0, void 0, function* () {
        var _a;
        if (ref !== null && ((_a = ref === null || ref === void 0 ? void 0 : ref.current) === null || _a === void 0 ? void 0 : _a.container)) {
            setIsLoading(true);
            return yield html2canvas(ref.current.container, Object.assign({ logging: false }, options)).then((canvas) => {
                setIsLoading(false);
...
class CurrentPng extends Component {
    constructor() {
        super(...arguments);
        ...
        this.getPng = (options) => __awaiter(this, void 0, void 0, function* () {
            var _a;
            if ((_a = this.chartRef.current) === null || _a === void 0 ? void 0 : _a.container) {
                this.setState({ isLoading: true });
                return yield html2canvas(this.chartRef.current.container, Object.assign({}, options)).then((canvas) => {
...
export { CurrentPng, useCurrentPng, useGenerateImage };
